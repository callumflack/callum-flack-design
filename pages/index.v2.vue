            ...
            .u-md-size1of2
              .Container.m-l0.p-a0
                .u-flex.u-flexAlignItemsCenter.md-Slide-height
                  ImageLazy(src="https://res.cloudinary.com/pw-img-cdn/image/upload/v1528294818/okok/_glow-av.jpg")
...
.Box-text {
  margin: 0;
  padding: calc(0.8 * var(--s-3b)) var(--s-3b);
  position: relative;

  @media (--lg) {
    padding: calc(0.8 * var(--s-4)) var(--s-4);
  }
}
