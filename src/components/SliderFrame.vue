<script>
/*
  This simple slider consist of:
  * SliderFrame
  * SlidesSlides
  * SlidesSlide

  See: https://markus.oberlehner.net/blog/building-a-simple-content-slider-with-vue/
...
export default {
  ...
  computed: {
    slides() {
      ...
      return this.$children.find(x => x.$options.name === "SliderSlides")
        .$children;
    },
    slidesCount() {
