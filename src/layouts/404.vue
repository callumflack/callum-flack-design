    ...
    <header>
      <HeaderTitleWrap>
        ...
        <p class="Link Text--sm text-gray s-2xh">
          Sorry, I couldn't find the page you were after. To apologise for my indiscretion, here's a randomly generated insight about good interface design:
        </p>
        <p class="Quote Title">
          {{ selectedQuote.line }}
          <em class="Quote-author">
            <a :href="selectedQuote.link" target="_blank" rel="noopener noreferrer">{{ selectedQuote.author }}</a>
          </em>
        </p>
      </HeaderTitleWrap>
    </header>
...
export default {
  ...
  data() {
    return {
      quotes: [
        {
          line: "People care about their problems more than they care about design. Solve their problems, and they’ll learn to care about design.",
          author: "Daniel Burka",
          link: "https://twitter.com/johnmaeda/status/753744840945442816",
        },
        {
          line: "Civilization advances by extending the number of important operations which we can perform without thinking about them.",
          author: "Alfred Whitehead",
          link: "https://www.goodreads.com/quotes/53970-civilization-advances-by-extending-the-number-of-important-operations-which"
        },
        {
          line: "Instead of trying to organize it in full detail, you organize it only somewhat and you then rely on the dynamics of the system to take you in the direction you want to go.",
          author: "Brian Eno",
          link: "https://www.edge.org/conversation/brian_eno-composers-as-gardeners",
        },
        {
          line: "Design lets you rehearse the future. And we’re all competing with the future itself.",
          author: "Brian Collins",
          link: "https://www.forbes.com/sites/brucerogers/2019/03/04/design-as-change-agent-interview-with-brian-collins/#91043c24e27b"
        },
        {
          line: "Simplicity is a luxury item I'm happy to pay quite a lot of money for.",
          author: "Ole Peters",
